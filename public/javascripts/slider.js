	...
	$.movingBoxes = function(el, options){
		...
		base.update = function(flag){
			...
			base.$el.css({
				...
				//height   : Math.max.apply( this, base.heights ) + 200
				height	: element_height-30
			});
			//base.$window.css({ height : (base.options.fixedHeight) ? Math.max.apply( this, base.heights ) +240: base.heights[base.curPanel-1] +200});
			base.$window.css({ height : element_height-20});
